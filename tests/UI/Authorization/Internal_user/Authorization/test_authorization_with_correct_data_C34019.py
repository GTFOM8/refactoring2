...
def test_authorization_with_correct_data(app: Application, browser):
    ...
    try:
        ...
        app.auth_page.enter_login(username='admin', url=None)
        ...
        if error_occurred:
            ...
            app.report.report_test_result(case_id=case_id, status_id=1, test_steps=test_steps, error_description="")
