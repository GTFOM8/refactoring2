...
def test_authorization_with_correct_email_password_user_with_same_role(app: Application, browser):
    ...
    try:
        ...
        app.auth_page.enter_password(username='merchant2', url=None)
